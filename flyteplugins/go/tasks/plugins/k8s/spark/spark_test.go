...
import (
	...
	sj "github.com/kubeflow/spark-operator/api/v1beta2"
...
func TestBuildResourceContainer(t *testing.T) {
	...
	assert.NotNil(t, sparkApp.Spec.Driver.SparkPodSpec.Template.Spec.SecurityContext)
	assert.Equal(t, *sparkApp.Spec.Driver.SparkPodSpec.Template.Spec.SecurityContext.RunAsUser, *defaultConfig.DefaultPodSecurityContext.RunAsUser)
	...
	assert.NotNil(t, sparkApp.Spec.Executor.SparkPodSpec.Template.Spec.SecurityContext)
	assert.Equal(t, *sparkApp.Spec.Executor.SparkPodSpec.Template.Spec.SecurityContext.RunAsUser, *defaultConfig.DefaultPodSecurityContext.RunAsUser)
	...
	assert.Equal(t, "new-val", *sparkApp.Spec.Driver.SparkPodSpec.ServiceAccount)
...
func TestBuildResourcePodTemplate(t *testing.T) {
	...
	assert.Equal(t, flytek8s.GetServiceAccountNameFromTaskExecutionMetadata(taskCtx.TaskExecutionMetadata()), *sparkApp.Spec.Driver.ServiceAccount)
	assert.Equal(t, defaultConfig.DefaultPodSecurityContext, sparkApp.Spec.Driver.Template.Spec.SecurityContext)
	...
	assert.Equal(t, defaultConfig.DefaultPodSecurityContext, sparkApp.Spec.Executor.Template.Spec.SecurityContext)
